...
const statusValidation = [
  ...
  body('status').isIn(['ACTIVE', 'EXPIRED', 'LOST', 'CANCELLED']).withMessage('Invalid status.')
];
...
const getAllValidation = [
  ...
  query('sortBy').optional().isIn(['rfid_card_id', 'card_uid', 'status', 'issued_date', 'created_at']).withMessage('Invalid sort column.'),
